...
<div class="row">
  ...
  <div class="col-sm-12">
    ...
    <p style="font-size:10px"><?php echo T('PHYSICAL_MEMORY_TITLE'); ?>: <?php echo "$memPercent"; ?>%<br />
      <?php echo T('PHYSICAL_MEMORY_USED_TXT'); ?>: <font color='#eb4549'><?php echo "$mu"; ?></font> |
      <?php echo T('PHYSICAL_MEMORY_IDLE_TXT'); ?>: <font color='#eb4549'><?php echo "$mf"; ?></font>
    </p>
    <div class="progress progress-striped">
      ...
      ?>
      <div style="width:<?php echo "$memPercent"; ?>%" aria-valuemax="100" aria-valuemin="0"
        aria-valuenow="<?php echo "$memPercent"; ?>" role="progressbar" class="progress-bar <?php echo $ramcolor ?>">
  ...
  if ($sysInfo['memCached'] > 0) {
    ...
    <div class="col-sm-12" style="padding-top:10px">
      ...
      <p style="font-size:10px"><?php echo T('CACHED_MEMORY_TITLE'); ?>: <?php echo "$memCachedPercent"; ?>%<br />
        <?php echo T('CACHED_MEMORY_USAGE_TXT'); ?>   <?php echo "$mc"; ?> | <?php echo T('CACHED_MEMORY_BUFFERS_TXT'); ?>
        <?php echo "$mb"; ?>
      </p>
      <div class="progress progress-striped">
        <?php
        ...
        ?>
        <div style="width:<?php echo "$memCachedPercent"; ?>%" aria-valuemax="100" aria-valuemin="0"
          aria-valuenow="<?php echo "$memCachedPercent"; ?>" role="progressbar"
          class="progress-bar <?php echo $ramcolor ?>">
    ...
    <div class="col-sm-12" style="padding-top:10px">
      ...
      <p style="font-size:10px"><?php echo T('REAL_MEMORY_TITLE'); ?>: <?php echo "$memRealPercent"; ?>%<br />
        <?php echo T('REAL_MEMORY_USAGE_TXT'); ?>   <?php echo "$memRealUsed"; ?> | <?php echo T('REAL_MEMORY_FREE_TXT'); ?>
        <?php echo "$memRealFree"; ?>
      </p>
      <div class="progress progress-striped">
        <?php
        ...
        ?>
        <div style="width:<?php echo "$memRealPercent"; ?>%" aria-valuemax="100" aria-valuemin="0"
          aria-valuenow="<?php echo "$memRealPercent"; ?>" role="progressbar"
          class="progress-bar <?php echo $ramcolor ?>">
  ...
  if ($sysInfo['swapTotal'] > 0) {
    ...
    <div class="col-sm-12" style="padding-top:10px">
      ...
      <p style="font-size:10px"><?php echo T('SWAP_TITLE'); ?>: <?php echo "$swapPercent"; ?>%<br />
        <?php echo T('SWAP_TOTAL_TXT'); ?>: <?php echo T('TOTAL_L'); ?>   <?php echo $st; ?> |
        <?php echo T('SWAP_USED_TXT'); ?>   <?php echo "$su"; ?> | <?php echo T('SWAP_IDLE_TXT'); ?>   <?php echo "$sf"; ?>
      </p>
      <div class="progress progress-striped">
        <?php
        if ($swapPercent < "70") {
        ...
        ?>
        <div style="width:<?php echo "$swapPercent"; ?>%" aria-valuemax="100" aria-valuemin="0"
          aria-valuenow="<?php echo "$swapPercent"; ?>" role="progressbar" class="progress-bar <?php echo $ramcolor ?>">
...
<h4 class="nomargin"><?php echo $memTotal; ?>
  <?php if (isAdmin()) { ?>
    <a href="?clean_mem=true" id="cleanmem" data-toggle="modal" data-target="#sysResponse" style="margin: 0 auto"> <button
        class="btn btn-xs btn-default pull-right"><?php echo T('CLEAR_CACHE'); ?></button></a>
  <?php } ?>
</h4>