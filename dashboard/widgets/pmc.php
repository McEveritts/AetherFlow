        ...
        <tbody>
          <tr>
            ...
            <?php if (file_exists("/install/.btsync.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#btsyncRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-btsync=true"
                  data-toggle="modal" data-target="#sysResponse" id="btsyncInstall"
          ...
          <tr>
            ...
            <?php if (file_exists("/install/.couchpotato.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#couchpotatoRemovalConfirm"
            ...
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-couchpotato=true"
                  data-toggle="modal" data-target="#sysResponse" id="couchpotatoInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.csf.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#csfRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a></td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button data-toggle="tooltip"
          ...
          <tr>
            ...
            <?php if (file_exists("/install/.deluge.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#delugeRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-deluge=true"
                  data-toggle="modal" data-target="#sysResponse" id="delugeInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.emby.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#embyRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a></td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-emby=true"
                  data-toggle="modal" data-target="#sysResponse" id="embyInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.headphones.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#headphonesRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-headphones=true"
                  data-toggle="modal" data-target="#sysResponse" id="headphonesInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.jackett.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#jackettRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-jackett=true"
                  data-toggle="modal" data-target="#sysResponse" id="jackettInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.lidarr.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#lidarrRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-lidarr=true"
                  data-toggle="modal" data-target="#sysResponse" id="lidarrInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.medusa.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#medusaRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-medusa=true"
                  data-toggle="modal" data-target="#sysResponse" id="medusaInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.nextcloud.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#nextcloudRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button data-toggle="tooltip"
          ...
          <tr>
            ...
            <?php if (file_exists("/install/.nzbget.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#nzbgetRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-nzbget=true"
                  data-toggle="modal" data-target="#sysResponse" id="nzbgetInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.nzbhydra.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#nzbhydraRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-nzbhydra=true"
                  data-toggle="modal" data-target="#sysResponse" id="nzbhydraInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.ombi.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#ombiRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a></td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-ombi=true"
                  data-toggle="modal" data-target="#sysResponse" id="ombiInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <?php if (file_exists("/install/.plex.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#plexRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a></td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-plex=true"
                  data-toggle="modal" data-target="#sysResponse" id="plexInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.pyload.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#pyloadRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-pyload=true"
                  data-toggle="modal" data-target="#sysResponse" id="pyloadInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.quassel.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#quasselRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-quassel=true"
                  data-toggle="modal" data-target="#sysResponse" id="quasselInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.quota.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#quotaRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a></td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-quota=true"
                  data-toggle="modal" data-target="#sysResponse" id="quotaInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.radarr.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#radarrRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-radarr=true"
                  data-toggle="modal" data-target="#sysResponse" id="radarrInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.rapidleech.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#rapidleechRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-rapidleech=true"
                  data-toggle="modal" data-target="#sysResponse" id="rapidleechInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.sabnzbd.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#sabnzbdRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-sabnzbd=true"
                  data-toggle="modal" data-target="#sysResponse" id="sabnzbdInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.sickgear.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#sickgearRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-sickgear=true"
                  data-toggle="modal" data-target="#sysResponse" id="sickgearInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.sickrage.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#sickrageRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-sickrage=true"
                  data-toggle="modal" data-target="#sysResponse" id="sickrageInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.sonarr.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#sonarrRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-sonarr=true"
                  data-toggle="modal" data-target="#sysResponse" id="sonarrInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.subsonic.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#subsonicRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-subsonic=true"
                  data-toggle="modal" data-target="#sysResponse" id="subsonicInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.syncthing.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#syncthingRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-syncthing=true"
                  data-toggle="modal" data-target="#sysResponse" id="syncthingInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.Tautulli.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#TautulliRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a>
              </td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-Tautulli=true"
                  data-toggle="modal" data-target="#sysResponse" id="TautulliInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.transmission.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#transmissionRemovalConfirm"
                  class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a></td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-transmission=true"
                  data-toggle="modal" data-target="#sysResponse" id="transmissionInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.qbittorrent.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#qbittorrentRemovalConfirm"
                  class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a></td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-qbittorrent=true"
                  data-toggle="modal" data-target="#sysResponse" id="qbittorrentInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.x2go.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#x2goRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a></td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><a href="?installpackage-x2go=true"
                  data-toggle="modal" data-target="#sysResponse" id="x2goInstall"
                  class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
            <?php } ?>
          </tr>
          <tr>
            ...
            <?php if (file_exists("/install/.znc.lock")) { ?>
              <td style="vertical-align: middle; text-align: center"><a href="javascript:void()" data-toggle="modal"
                  data-target="#zncRemovalConfirm" class="btn btn-xs btn-success"><?php echo T('INSTALLED'); ?></a></td>
            <?php } else { ?>
              <td style="vertical-align: middle; text-align: center"><button data-toggle="tooltip"
